...
class plgContentSigPlusNovo extends JPlugin {
	...
	*/
	public function onContentAfterSave($context, &$article, $isNew) {
		if (!empty($article->introtext)) {
			$this->parseContent($article->introtext);  // replacements will not be saved
		}
		if (!empty($article->fulltext)) {
			$this->parseContent($article->fulltext);  // replacements will not be saved
		}
		return true;
	}
	...
	*/
	...
	public function onExtensionAfterSave($context, $table, $isNew) {
		...
		if (isset($params['clean_database']) && $params['clean_database']) {
